...
export const SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { key: 'voice', label: '语音更新', icon: 'voice', kind: 'route', page: 'voice', visible: canSubmitUpdate },
  { key: 'meeting', label: '会议纪要', icon: 'doc', kind: 'route', page: 'meeting', visible: canViewMeetings },
  { key: 'confirm', label: 'AI确认中心', icon: 'confirm', kind: 'route', page: 'confirm', visible: canViewOwnerConfirmCenter },
